...
public class Constants {
    ...
    public static final String PROJECT_NAME = "REST Assured Framework | Karthik Sivaraj";
    public static final String REPORT_TITLE = "REST Assured Framework | Karthik Sivaraj\"";
